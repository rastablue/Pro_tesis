            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="group">
                            @can('vehiculos.show')
                                <a href="{{ route('vehiculos.reportes') }}" class="btn btn-sm btn-primary text-white" target="_blank">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="vehiculos-table" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>Placa</th>
                                        <th>Marca</th>
