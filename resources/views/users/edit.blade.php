                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text" placeholder="{{ $user->cedula }}" class="form-control @error('cedula') is-invalid @enderror" name="cedula" value="{{ old('cedula') }}" required autocomplete="cedula" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apellido_pater" type="text" placeholder="{{ $user->apellido_pater }}" class="form-control @error('apellido_pater') is-invalid @enderror" name="apellido_pater" value="{{ old('apellido_pater') }}" required autocomplete="apellido_pater" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apellido_mater" type="text" placeholder="{{ $user->apellido_mater }}" class="form-control @error('apellido_mater') is-invalid @enderror" name="apellido_mater" value="{{ old('apellido_mater') }}" required autocomplete="apellido_mater" autofocus>
