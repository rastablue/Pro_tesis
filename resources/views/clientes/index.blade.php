            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span><h4><b>Clientes</b></h4></span>
                        <div class="group">
                            @can('clientes.show')
                                <a href=" {{ route('clientes.reportes') }} " class="btn btn-sm btn-primary text-white" target="_blank">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                    <div class="modal-body">
                        <h6 align="center">
                            Eliminar a este cliente no eliminara los vehiculos vinculados,
                            sin embargo, aquellos vehiculos ya no quedaran vinculados a
                            ningun cliente.
                            <br><br><b>¿Desea continuar?</b></h6>
                    </div>
                <!-- Modal footer -->
                    <div class="modal-footer">
